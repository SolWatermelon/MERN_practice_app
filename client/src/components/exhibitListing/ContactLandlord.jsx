...
const ContactLandlord = ({ listingData }) => {
  ...
  return (
    <>
      <div className="text-hoverlighttext bg-white shadow-md mb-16 md:sticky md:top-3 p-3 w-[250px]">
        ...
        <Contact openMessageArea={openMessageArea} listingData={listingData}/>
      </div>
      {/* )} */}
    </>
  );
