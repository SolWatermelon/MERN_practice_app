...
const {data, isPending, error, isError, isSuccess, refetch} = getAllListingsDataQuery
  useEffect(() => {
  ...
  return (
    <>
       ...
       {isSuccess &&        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-500 rounded-md">
